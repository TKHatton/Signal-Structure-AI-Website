...
type ServiceKey = 'score' | 'watch' | 'fix' | 'authority' | 'growth' | 'publish' | 'mcp';
type Known = 'no' | 'yes';
type Goal = 'know' | 'fix' | 'content' | 'chat' | 'track';
type Who = 'me' | 'you';
...
const REEL: ServiceKey[] = ['score', 'watch', 'fix', 'authority', 'growth', 'publish', 'mcp'];

function recommend(a: Answers): { best: ServiceKey; next: ServiceKey | null } {
